...
namespace App\Formatter\Connection;
...
class ConnectionFormatter
{
    ...
    //         'confirmUrl' => $this->urlGenerator->generate('api_v1_confirm_connection', ['id' => $connection->getId()]),
    //         'deleteUrl' => $this->urlGenerator->generate('api_v1_delete_connection', ['id' => $connection->getId()]),
    //     ];
    // }
}